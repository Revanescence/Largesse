    ...
    <div className="flex justify-center flex-col items-center text-white h-[40vh]">
      <div className="flex font-bold gap-2 text-5xl justify-center items-center">Give me Cookies <span>
        ...
        <div className="flex flex-col items-center">
          ...
          <div><button type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Purple to Blue</button>
